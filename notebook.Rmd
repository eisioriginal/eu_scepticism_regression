...
chisq.out <- apply(dtm_final_train, 2, function(x) chisq.test(x, train_labels)$statistic)
chisq.out_dict <- apply(dtm_final_train_dict, 2, function(x) chisq.test(x, train_labels_dict)$statistic)
