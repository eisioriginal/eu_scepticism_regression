...
\textsc{\LARGE Leipzig University}\\[0.2cm]
\textsc{\Large Abteilung Automatische Sprachverarbeitung}\\[0.3cm]
{
   \vskip 13.5pt\relax \normalsize\fontsize{11}{12} 
$if(anonymous)$\hfill $else$$for(author)$\textbf{\authorfont $author.name$} \\[1pt] 
\emph{\small $author.email$}\\[1pt]
\emph{\small $author.affiliation$}\\[3pt]  $sep$ \par $endfor$ $endif$
}
\vskip 10.5pt\relax
\HRule \\[0.4cm]
{\huge \bfseries $title$}\\
